...
const Sidebar = ({ isMenuOpen, isGenerating, setIsGenerating, setProject, project }: SidebarProps) => {
            ...
            .map((message) => {
              ...
              if (isMessage) {
                ...
                ${isUser ? "justify-end" : "justify-start"}`}>
                    ...
                    <div className={`max-w-[80%] p-2 px-4 rounded-2xl shadow-sm
                    text-sm mt-5 leading-relaxed ${isUser ?
