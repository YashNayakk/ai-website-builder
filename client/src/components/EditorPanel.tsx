...
const EditorPanel = ({ selectedElement, onUpdate, onClose }: EditorPanelProps) => {
    ...
    return (
        <div className='absolute top-4 right-4 w-80 bg-white rounded-lg
        shadow-xl border border-gray-200 p-4 z-50 animate-in fade-in
