...
const steps = [{ icon: ScanLineIcon, label: "Analyzing your request..." },
    ...
    return (
      ...
      bg-gray-950 relative overflow-hidden text-white">
        ...
        via-purple-500/10 to-fuchsia-500/10 blur-3xl animate-pulse"></div>
            <div className="relative z-10 w-32 h-32 flex items-center
     justify-center"> <div className="absolute inset-0 rounded-full 
     border border-indigo-400 animate-ping opacity-30" />
       ...
       border-purple-400/20" />
        ...
        tracking-wide transition-all duration-700 ease-in-out opacity-100">
            ...
            <p className="text-sx text-gray-400 mt-2 transition-opacity duration-700 opacity-100">
